...
export function Header({ title, breadcrumbs }: HeaderProps) {
  return (
    <header className="flex items-center justify-between px-4 py-3 md:px-6 md:py-4 bg-white border-b border-[var(--gray-200)]">
      ...
      <div className="flex flex-col gap-1 min-w-0">
        ...
        {/* Title */}
        <h1 className="text-2xl font-semibold text-[var(--gray-900)] leading-tight truncate">
          {title}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-2 shrink-0 ml-4">
        {/* Bell button */}
        <button
          className="relative p-2 rounded-md text-[var(--gray-500)] hover:bg-[var(--gray-50)] hover:text-[var(--gray-700)] transition-colors"
